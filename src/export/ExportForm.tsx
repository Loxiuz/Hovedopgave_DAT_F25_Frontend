...
export default function ExportForm() {
    ...
    function handleRemoveFilterBtnClick(e: React.MouseEvent<HTMLButtonElement>, i: number, entity: string) {
        e.preventDefault();
        setSelectedEntitiesFilters((prev) =>
    ...
    function handleAddFilterBtnClick(e: React.MouseEvent<HTMLButtonElement>, entity: string) {
        e.preventDefault();
        setSelectedEntitiesFilters((prev) => [
            ...prev,
            { [entity]: { field: "", value: "" } },
